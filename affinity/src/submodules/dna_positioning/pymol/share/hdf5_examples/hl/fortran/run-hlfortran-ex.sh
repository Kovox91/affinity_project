...
prefix="${prefix:-/home/appveyor/projects/pymol-incentive/ci-bundle-311/_pymolconda}"
PARALLEL=no             # Am I in parallel mode?
AR="/home/conda/feedstock_root/build_artifacts/hdf5_1733002043084/_build_env/bin/x86_64-conda-linux-gnu-ar"
RANLIB="/home/conda/feedstock_root/build_artifacts/hdf5_1733002043084/_build_env/bin/x86_64-conda-linux-gnu-ranlib"
if [ "$PARALLEL" = no ]; then
