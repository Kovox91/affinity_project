export CONDA_EXE="$(cd "`dirname "$BASH_SOURCE"`" && pwd)/../../bin/conda"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/home/appveyor/projects/pymol-incentive/ci-bundle-311/_pymolconda/bin/python'
